    ...
    return(
        <div className="mx-5">
            ...
            <article>
                ...
                <p>Hobbies of mine include biking all over town, other outdoors fun including hiking, and solving every kind of puzzle in existence, including jigsaws, sudokus, crosswords and many others! I also enjoy playing games, reading, and watching videos on YouTube.</p>
                <p>Click the links above to see my projects, resume, and how to contact me</p>
            </article>
        </div>
    )
}
